...
import { HStack, Input, Flex, Center, Text, Box } from 'native-base'
import { MagnifyingGlass } from '../components/primitives/Icon/Custom'
...
export default ({ items, tab }) => {
  ...
  return (
    ...
    >
      ...
      <Items items={items} noImages={false} tab="fieldguide" />
    </Container>
  )
}
